...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['business', '-created_at'], name='audits_audi_busines_957b23_idx'), models.Index(fields=['user', '-created_at'], name='audits_audi_user_id_412723_idx'), models.Index(fields=['model_name', 'object_id'], name='audits_audi_model_n_9b0991_idx')],
            },
        ),
    ]
